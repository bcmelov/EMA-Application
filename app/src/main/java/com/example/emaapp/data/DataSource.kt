...
////list of all students
//val users: Call<Result> = service.getCharacters("")
////list of Android students
//val android_users: Call<Result> = service.getCharacters("androidMentor")
////list of iOS students
//val iOS_users: Call<Result> = service.getCharacters("iOSMentor")